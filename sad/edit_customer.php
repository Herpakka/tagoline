	...
	<div class="container"> 
		<div class="row">
			<div class="col-sm-6">
				...
				<form method="POST" action="update/update_customer.php">
					...
					<label>status:</label>
					<input type="number" name="status" class="form-control" value=<?=$row['Lavel']?> placeholder="...0=user 1=admin" required> <br>
